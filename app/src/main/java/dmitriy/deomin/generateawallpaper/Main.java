...
public class Main extends FragmentActivity {
    ...
    public void Menu(View v) {
        ...
        ((TextView) content.findViewById(R.id.textView_info_6)).setTypeface(face);
        ...
        CheckBox checkBox_anim = (CheckBox) content.findViewById(R.id.checkBox_animcia);
        checkBox_anim .setTypeface(face);
        checkBox_anim .setChecked(save_read_bool("ANIMACIA_RUN"));
        checkBox_anim .setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
